...
namespace HotPathAllocationAnalyzer.Test.Analyzers
{
    ...
    public class DisplayClassAllocationAnalyzerTests : AllocationAnalyzerTests
    {
        ...
        public void DisplayClassAllocation_AnonymousMethodExpressionSyntax()
        {
            ...
            var info = ProcessCode(analyser, sampleProgram, [SyntaxKind.ParenthesizedLambdaExpression, SyntaxKind.SimpleLambdaExpression, SyntaxKind.AnonymousMethodExpression]);
        ...
        public void DisplayClassAllocation_SimpleLambdaExpressionSyntax()
        {
            ...
            var analyser = new DisplayClassAllocationAnalyzer(true);
            var info = ProcessCode(analyser, sampleProgram, [SyntaxKind.SimpleLambdaExpression]);
        ...
        public void DisplayClassAllocation_ParenthesizedLambdaExpressionSyntax()
        {
            ...
            var analyser = new DisplayClassAllocationAnalyzer(true);
            var info = ProcessCode(analyser, sampleProgram, [SyntaxKind.ParenthesizedLambdaExpression]);
        ...
        public void DisplayClassAllocation_DoNotReportForNonCapturingAnonymousMethod()
        {
            ...
            var analyser = new DisplayClassAllocationAnalyzer(true);
            var info = ProcessCode(analyser, snippet, []);
        ...
        public void DisplayClassAllocation_ReportForCapturingAnonymousMethod()
        {
            ...
            var info = ProcessCode(analyser, snippet, []);
            Assert.AreEqual(2, info.Allocations.Count);
            AssertEx.ContainsDiagnostic(info.Allocations, id: DisplayClassAllocationAnalyzer.ClosureCaptureRule.Id, line: 2, character: 9);
            AssertEx.ContainsDiagnostic(info.Allocations, id: DisplayClassAllocationAnalyzer.ClosureDriverRule.Id, line: 3, character: 28);
        }
    }
}
