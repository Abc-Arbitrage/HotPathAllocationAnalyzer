...
namespace HotPathAllocationAnalyzer.Configuration
{
    public class ConfigurationReader
    {
        ...
        {
            var disclaimer = "#  This file is automatically generated from the classes implementing AllocationConfiguration, DO NOT MODIFY IT MANUALLY it is overrided every time the configuration project is compiled";
